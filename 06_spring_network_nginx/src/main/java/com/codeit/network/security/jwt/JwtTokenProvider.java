...
public class JwtTokenProvider {
    ...
    public String generateAccessToken(MyUserDetails userDetails) throws JOSEException {
        return generateToken(userDetails, accessTokenExpirationMs, accessTokenSigner, "access");
    }

    // Refresh Token 생성 메서드(장기, 쿠키로 응답 예정)
    public String generateRefreshToken(MyUserDetails userDetails) throws JOSEException {
