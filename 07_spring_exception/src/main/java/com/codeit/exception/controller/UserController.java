...
public class UserController {
    ...
    public String handleIllegalArgumentException(UserNotFoundException ex, Model model) {
        ex.printStackTrace();
        model.addAttribute("error", ErrorResponse.of(ErrorCode.INVALID_REQUEST, ex.getMessage()));
        return "error/errorPage";
    }
    ...
    public String handleIllegalArgumentException(AccessDeniedException ex, Model model) {
        ex.printStackTrace();
        model.addAttribute("error", ErrorResponse.of(ErrorCode.INVALID_REQUEST, ex.getMessage()));
        return "error/errorPage";
    }
